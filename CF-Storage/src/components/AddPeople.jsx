...
import './AddPeopleStyle.css'; // Make sure to style your modal
...
function ProfileCard({ name, email, hasAccess, onChangeAccess }) {
  ...
  return (
    <section className="profile-card">
      ...
      <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/64704d70ae65fb23ca56a665889a561794a384add85b66caa6931140b9db8caa?apiKey=61b20d1a1e1848d2bcaf0e442b285d46&" className="profile-img" />
...
function MyComponent({ show, onClose, objectId, users }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:8000/objects/update_access', requestData);
  ...
  // const filteredUsers = users.filter((user) => user.username !== ownerId);
